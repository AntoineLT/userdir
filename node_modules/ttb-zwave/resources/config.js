...
config.debug = true;
config.modpath = '/root/thethingbox/node_modules/node-red/node_modules/ttb-zwave/resources/node-openzwave/lib';
config.saveconfig = false;
config.logging =  false; 
config.consoleoutput = false;
config.suppressrefresh = true;
config.pollinterval = 500;
config.device = '/dev/ttyACM0'; // Z-Stick Gen5
//config.device = '/dev/ttyUSB0'; // Z-Stick S2
config.smoke = {};
config.presencecontent = {};
...
config.power.message = {};
config.power.message.warning = "Attention, la maison consomme {0} Watt";

// Presence detection
config.presencecontent.alert = {};
config.presencecontent.alert.subject = 'Alerte intrusion';
config.presencecontent.alert.message = 'Une présence anormale a été détectée';
